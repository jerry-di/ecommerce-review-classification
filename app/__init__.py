...
# v1（sklearn）/ v2（fastText）模型已废弃，依赖 jieba/fasttext 且与现有多任务模型不匹配
# from app.v1.prediction import api_v1_bp
# from app.v2.prediction import api_v2_bp
from app.v3.prediction import api_v3_bp
from app.auth import auth_bp
from app.history import history_bp
from app.analyze import analysis_bp
from app.async_tasks import async_bp
